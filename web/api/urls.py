...
urlpatterns = [
    ...
    path('obsidian/study-set/preview', views.obsidian_study_set_preview, name='obsidian-study-set-preview'),
    path('obsidian/study-set/apply', views.obsidian_study_set_apply, name='obsidian-study-set-apply'),
